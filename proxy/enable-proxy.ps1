...
# Usage: .\proxy\enable-proxy.ps1
# To undo: .\proxy\disable-proxy.ps1
...
if (-not (Test-Path $caCert)) {
    ...
    Write-Host "  Run mitmproxy once to generate it:  .\proxy\start.ps1" -ForegroundColor Yellow
    exit 1
}
...
Write-Host "  To disable:  .\proxy\disable-proxy.ps1" -ForegroundColor DarkGray
Write-Host ""
